  ...
  render() {
    const infoPanelControl = this.state.isInfoPanelOpen ? (
      <Image
        ...
        source={asset("icons/iconfinder_close_32391.png")}
      />
    ) : (
      <Image
        style={style.infoButton}
        source={asset("icons/iconfinder_info-blog_46810.png")}
      />
    );
    ...
    const returnButton = (
      <Image
        ...
        source={asset("icons/iconfinder_Arrow_doodle_16_3847918.png")}
      />
    );
...
const mapDispatchToProps = dispatch => {
  return {
    openInfoPanel: isInfoPanelOpen =>
      dispatch({ type: "CHANGE_INFOPANEL_STATE", val: isInfoPanelOpen }),
